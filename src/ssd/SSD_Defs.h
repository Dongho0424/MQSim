...
typedef uint64_t LHA_type;  // Logical Host Address, the addresses unit on the host-side. As
                            // of 2018, LHA is mainly a sector (i.e., 512B) but it could be
                            // as small as a cache-line (i.e., 64B) in future NVMs.
