...
unsigned int Stats::Total_page_movements_for_gc = 0,
             Stats::Total_gc_page_movements_per_stream[MAX_SUPPORT_STREAMS] = {0};
...
unsigned int Stats::Total_page_movements_for_wl = 0,
             Stats::Total_wl_page_movements_per_stream[MAX_SUPPORT_STREAMS] = {0};
...
unsigned int Stats::total_CMT_queries_per_stream[MAX_SUPPORT_STREAMS] = {0},
...
void Stats::Init_stats(unsigned int channel_no, unsigned int chip_no_per_channel, unsigned int die_no_per_chip,
    ...
    for (unsigned int chip_cntr = 0; chip_cntr < chip_no_per_channel; chip_cntr++) {
      ...
      for (unsigned int die_cntr = 0; die_cntr < die_no_per_chip; die_cntr++) {
        ...
        for (unsigned int plane_cntr = 0; plane_cntr < plane_no_per_die; plane_cntr++) {
          ...
          Block_erase_histogram[channel_cntr][chip_cntr][die_cntr][plane_cntr][0] =
              block_no_per_plane * page_no_per_block;  // At the start of the
...
void Stats::Clear_stats(unsigned int channel_no, unsigned int chip_no_per_channel, unsigned int die_no_per_chip,
                        unsigned int plane_no_per_die, unsigned int block_no_per_plane, unsigned int page_no_per_block,
                        unsigned int max_allowed_block_erase_count) {
  for (unsigned int channel_cntr = 0; channel_cntr < channel_no; channel_cntr++) {
    for (unsigned int chip_cntr = 0; chip_cntr < chip_no_per_channel; chip_cntr++) {
