  ...
  switch (sharing_mode) {
    ...
    case SSD_Components::Cache_Sharing_Mode::EQUAL_PARTITIONING:
      ...
      dram_execution_queue =
          new std::queue<Memory_Transfer_Info*>[stream_count];
      waiting_user_requests_queue_for_dram_free_slot =
  ...
  if (transaction->Type == Transaction_Type::READ) {
    ...
    switch (Data_Cache_Manager_Flash_Advanced::caching_mode_per_input_stream
      ...
      case Caching_Mode::WRITE_CACHE:
        ...
        if (_my_instance->is_user_request_finished(
      ...
      case Caching_Mode::WRITE_READ_CACHE: {
        if (((Data_Cache_Manager_Flash_Advanced*)_my_instance)
          ...
          ((Data_Cache_Manager_Flash_Advanced*)_my_instance)
              ->per_stream_cache[transaction->Stream_id]
              ->Update_data(transaction->Stream_id, transaction->LPA, content,
                            timestamp,
          ...
          if (!((Data_Cache_Manager_Flash_Advanced*)_my_instance)
            ...
            if (evicted_slot.Status ==
              ...
              transfer_info->next_event_type =
                  Data_Cache_Simulation_Event_Type::
                      MEMORY_READ_FOR_CACHE_EVICTION_FINISHED;
    ...
    switch (Data_Cache_Manager_Flash_Advanced::caching_mode_per_input_stream
      ...
      case Caching_Mode::WRITE_READ_CACHE: {
        ...
        ((Data_Cache_Manager_Flash_Advanced*)_my_instance)
            ...
            (transaction->Data_and_metadata_size_in_byte %
                         SECTOR_SIZE_IN_BYTE ==
                     0
                 ? 0
                 : 1);
...
void Data_Cache_Manager_Flash_Advanced::Execute_simulator_event(
  ...
  switch (eventType) {
    case Data_Cache_Simulation_Event_Type::
        MEMORY_READ_FOR_USERIO_FINISHED:  // A user read is service from DRAM
                                          // cache
    ...
    case Data_Cache_Simulation_Event_Type::
      ...
      break;
    case Data_Cache_Simulation_Event_Type::
        MEMORY_WRITE_FOR_CACHE_FINISHED:  // The recently read data from flash
