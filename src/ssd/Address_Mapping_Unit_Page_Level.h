...
class Cached_Mapping_Table {
 public:
  ...
  void Update_mapping_info(const stream_id_type streamID, const LPA_type lpa, const PPA_type ppa,
                           const page_status_type pageWriteState);
  void Insert_new_mapping_info(const stream_id_type streamID, const LPA_type lpa, const PPA_type ppa,
...
class Address_Mapping_Unit_Page_Level : public Address_Mapping_Unit_Base {
 ...
 public:
  Address_Mapping_Unit_Page_Level(
      ...
      Flash_Plane_Allocation_Scheme_Type PlaneAllocationScheme, unsigned int ConcurrentStreamNo,
      unsigned int ChannelCount, unsigned int chip_no_per_channel, unsigned int DieNoPerChip,
      unsigned int PlaneNoPerDie, std::vector<std::vector<flash_channel_ID_type>> stream_channel_ids,
  ...
  void Allocate_address_for_preconditioning(const stream_id_type stream_id,
  ...
  void Get_data_mapping_info_for_gc(const stream_id_type stream_id, const LPA_type lpa, PPA_type& ppa,
                                    page_status_type& page_state);
  void Get_translation_mapping_info_for_gc(const stream_id_type stream_id, const MVPN_type mvpn, MPPN_type& mppa,
 ...
 private:
  ...
  void allocate_plane_for_preconditioning(stream_id_type stream_id, LPA_type lpn,
