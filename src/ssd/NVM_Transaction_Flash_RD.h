...
class NVM_Transaction_Flash_RD : public NVM_Transaction_Flash {
 public:
  NVM_Transaction_Flash_RD(Transaction_Source_Type source, stream_id_type stream_id, unsigned int data_size_in_byte,
  ...
  NVM_Transaction_Flash_RD(Transaction_Source_Type source, stream_id_type stream_id, unsigned int data_size_in_byte,
                           ...
                           NVM_Transaction_Flash_WR* related_write, page_status_type read_sectors_bitmap,
