...
class Input_Stream_Manager_SATA : public Input_Stream_Manager_Base {
 public:
  Input_Stream_Manager_SATA(Host_Interface_Base* host_interface, uint16_t ncq_depth,
...
class Host_Interface_SATA : public Host_Interface_Base {
 ...
 public:
  Host_Interface_SATA(const sim_object_id_type& id, const uint16_t ncq_depth, const LHA_type max_logical_sector_address,
