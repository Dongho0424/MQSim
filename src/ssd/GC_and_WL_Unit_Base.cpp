  ...
  switch (transaction->Source) {
    ...
    case Transaction_Source_Type::CACHE:
      switch (transaction->Type) {
        ...
        default:
          PRINT_ERROR(
              "Unexpected situation in the GC_and_WL_Unit_Base function!")
      }
                ...
                if (_my_instance->use_copyback) {
                  gc_wl_write = new NVM_Transaction_Flash_WR(
                      ...
                      _my_instance->address_mapping_unit
                          ->Convert_address_to_ppa(gc_wl_candidate_address),
    ...
    case Transaction_Type::ERASE:
      ...
      _my_instance->address_mapping_unit
          ->Start_servicing_writes_for_overfull_plane(
              transaction
                  ->Address);  // Must be inovked after above statements since
