...
class GC_and_WL_Unit_Page_Level : public GC_and_WL_Unit_Base {
 public:
  GC_and_WL_Unit_Page_Level(const sim_object_id_type& id, Address_Mapping_Unit_Base* address_mapping_unit,
                            ...
                            unsigned int page_no_per_block, unsigned int sectors_per_page, bool use_copyback,
  ...
  void Check_gc_required(const unsigned int free_block_pool_size,
