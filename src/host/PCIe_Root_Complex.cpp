...
PCIe_Root_Complex::PCIe_Root_Complex(PCIe_Link* pcie_link, HostInterface_Types SSD_device_type, SATA_HBA* sata_hba,
...
// NVMe Completion Queue Entry(CQE) 기록
...
// NVMe Submission Queue Entry(SQE)를 가져오는 데 사용
