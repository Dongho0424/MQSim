...
class IO_Flow_Synthetic : public IO_Flow_Base {
 public:
  IO_Flow_Synthetic(const sim_object_id_type& name, uint16_t flow_id, LHA_type start_lsa_on_device,
                    LHA_type end_lsa_on_device, double working_set_ratio, uint16_t io_queue_id,
                    ...
                    Utils::Address_Distribution_Type address_distribution, double hot_address_ratio,
